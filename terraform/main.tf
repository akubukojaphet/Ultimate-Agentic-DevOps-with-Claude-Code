...
# Grant CloudFront (via OAC) read access to the bucket. Access is
# scoped to this specific distribution using the SourceArn condition.
...
resource "aws_cloudfront_distribution" "site" {
  ...
  # SPA/deep-link friendly: serve index.html for not-found paths.
